            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Center(
                    child: (_productController.productImage.value!=null) ?Image.file(_productController.productImage.value!,height: 150,width: 150,): Image.asset(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              controller: _productController.productCostPriceController,
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              // maxLength: 6,
                              controller: _productController.productSellingPriceController,
                ...
                InkWell(
                  onTap: () {
                   if (_productController.addingProductStatus != AddingProductStatus.Loading){
                    if(widget.item==null)
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: AppColor().backgroundColor,
                        borderRadius: BorderRadius.circular(10)),
                    child:  (_productController.addingProductStatus == AddingProductStatus.Loading)
                          ? Container(
                              width: 30,
                              height: 30,
                              child: Center(
        ...
        final XFile? image = await _picker.pickImage(source: ImageSource.gallery);
         ...
         print("image path ${image.path}");
                  ...
                  child: Row(
                    ...
                    children: [
                     (_productController.productImage.value!=null) ?Image.file(_productController.productImage.value!,height: 150,width: 150,):Image.asset(
