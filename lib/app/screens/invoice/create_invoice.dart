                ...
                child: Row(
                  children: [
                    Radio<int>(
                        ...
                        onChanged: (value) => setState(() => _invoiceController.paymentValue = 1)),
                    Text(
                      'New Details',
                      style: TextStyle(
                        color: AppColor().backgroundColor,
                ...
                child: Row(
                  children: [
                    Radio<int>(
                        ...
                        activeColor: AppColor().backgroundColor,
                        groupValue: _invoiceController.paymentValue,
                        onChanged: (value) => setState(() => _invoiceController.paymentValue = 0)),
                    Text(
                      'Existing Details',
                      style: TextStyle(
                        color: AppColor().backgroundColor,
              ...
              ? Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<Bank>(
                                    value:
                                        _invoiceController.selectedBank,
                                    icon: Icon(
              ...
              : Form(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      // ),
                        ...
                        textEditingController:_bankAccountController.bankNameController,
                      ),
                      CustomTextFieldInvoiceOptional(
                        label: 'Account Name',
                        hint: 'account name',
                        ...
                        keyType: TextInputType.name,
                         textEditingController:_bankAccountController.bankAccountNameController,
                      ),
                      CustomTextFieldInvoiceOptional(
                        ...
                        keyType: TextInputType.phone,
                         textEditingController:_bankAccountController.accoutNumberController,
                      ),
               ...
               CustomTextField(
                        ...
                        textEditingController:
                            _invoiceController.dateController,
                        label: "Due Date",
                        hint: 'Select Date',
                        onClick: () {
                          pickDate(context);
                                  ...
                                  child: Row(
                                    children: [
                                      Radio<int>(
                                          ...
                                          activeColor: AppColor().backgroundColor,
                                          groupValue:
                                              _invoiceController.customerType,
                                          onChanged: (value) => setState(() =>
                                            _invoiceController
                                                  .customerType = 1)),
                                      Text(
