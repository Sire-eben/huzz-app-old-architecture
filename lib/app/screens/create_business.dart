...
SizedBox(height: 30,),
CustomTextField(label: "Business Name",validatorText: "Business name is required",),
SizedBox(height: 5,),
CustomTextField(label: "Address (Optional)",),
SizedBox(height: 5,),
CustomTextField(label: "Phone Number",validatorText: "Phone Number is needed",),
SizedBox(height: 5,),
CustomTextField(label: "Email",validatorText: "Email is required",),
