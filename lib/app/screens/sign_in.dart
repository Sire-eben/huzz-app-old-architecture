...
child: Form(
  ...
  SizedBox(height: 30,),
  Center(child: Text("Welcome back",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 24,color: AppColor().backgroundColor),)),
  SizedBox(height: 20,),
  Center(
    child: Text("Keep your business going with Huzz",style: TextStyle(color: Colors.black,fontSize:10,fontWeight: FontWeight.w400),
  )),
  ...
  SizedBox(width: 10,),
  Expanded(
    child:   TextFormField(controller:_authController.phoneNumberController ,
  ...
  validator: (value){
    ...
    decoration: InputDecoration(
      ...
      prefixText: "+${_authController.countryText} ",
  ...
  width: MediaQuery.of(context).size.width,
  margin: EdgeInsets.only(left: 20),
  child: Text("Enter your 4 digits PIN",style: TextStyle(fontSize: 12,color: Colors.black,fontWeight: FontWeight.w400),),
  ...
  mainAxisAlignment: MainAxisAlignment.center,
      children: [
        ...
        Icon(Icons.fingerprint,color: AppColor().backgroundColor,),
        SizedBox(width:10,),
        Text("SIGN IN WITH YOUR FINGERPRINT",style: TextStyle(color: AppColor().backgroundColor,fontSize: 12,fontWeight: FontWeight.w700),)
      ],
    ),
  ),
  SizedBox(height: 20,),
  Center(
    child:   Container(
      child: Text("Forget PIN?",style: TextStyle(color: Colors.red,fontSize: 12,fontWeight: FontWeight.w500),),
    ),
  ),
  Expanded(child: SizedBox()),
  Obx((){
      return GestureDetector(
        ...
        child:   Container(
            ...
            child:(_authController.signinStatus==SigninStatus.Loading)?Container(
                  width: 30,
                  height: 30,
