...
if(_authController.Otpverifystatus==OtpVerifyStatus.Error){
  errorController!.add(ErrorAnimationType
    ...
    child: Text("Enter OTP sent to your phone",style: TextStyle(color: Colors.black,fontSize: 12,fontWeight: FontWeight.w400,),)
...
_authController.sendVoiceOtp();
      ...
      child: Text("Send as Voice Call",style: TextStyle(color: AppColor().backgroundColor,fontSize: 12),)),
    ...
    GestureDetector(
      ...
      child: Text("Resend via sms",style: TextStyle(color: Color(0xffEF6500),fontSize: 12),)),
  ...
  _authController.verifyOpt();
      ...
      child:   Container(
          ...
          child: (_authController.Otpverifystatus==OtpVerifyStatus.Loading)?Container(
            width: 30,
            height: 30,
