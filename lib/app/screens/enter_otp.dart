...
SizedBox(height: 20,),
Text("Send as Voice Call",style: TextStyle(color: AppColor().backgroundColor,fontSize: 12),),

SizedBox(height: 20,),
Text("Resend via sms",style: TextStyle(color: Color(0xffEF6500),fontSize: 12),),
