                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: ((value=="Pending") ?(_debtorRepository.debtOwnedList.isEmpty):(_debtorRepository.fullyPaidDebtOwned.isEmpty))
                                ? Center(
                                    child: Column(
                                ...
                                : ListView.separated(
                                    ...
                                    itemCount:
                                     ((value=="Pending") ?(_debtorRepository.debtOwnedList.length):(_debtorRepository.fullyPaidDebtOwned.length)),
                                    itemBuilder: (context, index) {
                                      var item =
                                       ((value=="Pending") ?(_debtorRepository.debtOwnedList):(_debtorRepository.fullyPaidDebtOwned))[index];
                                      var customer = _customerRepository
                                          .checkifCustomerAvailableWithValue(
                                              item.customerId!);
    
                                      return (customer==null)?Container(): Row(
                                        children: [
                                          Expanded(
                                              child: Container(
                                            ...
                                            child: Align(
                                              ...
                                              child: Container(
                                                  ...
                                                  child: Center(
                                                      child: Text(
                                                   customer!=null&&customer!.name!=null && customer!.name!.length>0? '${customer!.name![0]}':"",
                                                    style: TextStyle(
                                                        fontSize: 30,
                                                        color: Colors.white,
                                                        fontFamily: 'DMSans',
