                      ...
                      child: Container(
                        ...
                        child: (_debtorController.debtorsList.isEmpty)
                            ...
                            : ListView.separated(
                                ...
                                itemCount:
                                    _debtorController.debtOwnedList.length,
                                itemBuilder: (context, index) {
                                  var item =
                                      _debtorController.debtOwnedList[index];
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    _debtorController.addBudinessDebtor("INCOME");
                  },
                  child: Padding(
                ...
                Obx(() {
                  return InkWell(
                    onTap: () {
                      setState(() {
                        _debtorController.addBudinessDebtor("EXPENDITURE");
                      });
                    },
                    child: Container(
                                ...
                                children: [
                                  CustomTextFieldInvoiceOptional(
                                    ...
                                    textEditingController:
                                        _debtorController.nameController,
                                  ),
                                  CustomTextFieldInvoiceOptional(
                                    label: 'Phone Number',
                                    keyType: TextInputType.name,
                                    textEditingController:
                                        _debtorController.phoneNumberController,
                                  ),
