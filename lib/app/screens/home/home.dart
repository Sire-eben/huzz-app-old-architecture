...
class _HomeState extends State<Home> {
  ...
  String? value;
  final _transactionsController=Get.find<TransactionRespository>();
  int selectedValue = 0;
  @override
                ...
                Expanded(
                  ...
                  child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        var item=_transactionsController.allPaymentItem[index];
                        return Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Row(
                      ...
                      itemCount: _transactionsController.allPaymentItem.length),
                ))
              ],
            ),
          ),
