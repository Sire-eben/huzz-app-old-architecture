...
productTypeList(List.from(json['productTypeList']));
 businessTransactionExpenseCategoryList(List.from(json['businessTransactionExpenseCategoryList']));
  businessTransactionPaymentModeList(List.from(json['businessTransactionPaymentModeList']));
businessTransactionPaymentSourceList(List.from(json['businessTransactionPaymentSourceList']));

businessTransactionTypeList(List.from(json['businessTransactionTypeList']));
