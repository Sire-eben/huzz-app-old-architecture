...
final response= await http.post(Uri.parse(ApiLink.send_smsOtp),body: jsonEncode({
...
Future sendVoiceOtp()async{
    // _Otpauthstatus(OtpAuthStatus.Loading);
final response= await http.post(Uri.parse(ApiLink.send_voiceOtp),body:jsonEncode( {
"phoneNumber":countryText+phoneNumberController.text
...
Future verifyOpt()async{
 ...
 final resposne=await http.post(Uri.parse(ApiLink.verify_otp),body: jsonEncode({
...
Future signIn()async{
print("phone number ${phoneNumberController.text}  country code ${countryText}");
try{
  _signinStatus(SigninStatus.Loading);
  final response= await http.post(Uri.parse(ApiLink.signin_user),body: jsonEncode({
...
_signinStatus(SigninStatus.Error);
  ...
  Get.snackbar("Login Error", "Something have occurred try again later.. ");
  _signinStatus(SigninStatus.Error);
}
